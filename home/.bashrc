...
alias enc='EDITOR=nvim sudoedit /etc/nixos/configuration.nix'
alias sn='EDITOR=nvim sudoedit'
alias snor='sudo nixos-rebuild switch'
alias snorf='sudo nixos-rebuild switch --flake /etc/nixos#default'
alias 'hms'='home-manager switch'
alias 'hmsf'='home-manager switch --flake ~/.config/home-manager/#amon'
