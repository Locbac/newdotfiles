...
# /bin/bash $HOME/.VFIOinput/external_drives_attach.sh & # Attaches external drives
# /bin/bash $HOME/.VFIOinput/input_attach.sh
...
wait $!     # Waits for the most recent background process (looking-glass-client) to exit
